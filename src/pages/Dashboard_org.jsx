              ...
              {createdEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-sm font-medium text-indigo-600 dark:text-indigo-300">🎫 ₹{event.price}</p>
                  </div>
                </div>
              ))}
            </div>
