...
const SignupForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-500 via-white to-violet-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-12 relative">
      ...
      <div
        className={`bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-4xl flex overflow-hidden transition-all duration-700 ${
        ...
        <div className="w-1/2 p-10">
          ...
          <div className="flex justify-center mb-6">
            <button
              ...
              className={`px-4 py-2 rounded-l-full font-semibold text-sm ${
                role === "User"
